...
// This is scoping, child function can access the parent function because its global. Internal is the child function here while external is global??
...
function lowPopulationAnimals(input) {
  return input.filter(animal => animal.population < 5);
}
