...
forEach() does not change the array on which it is called.  The map() method returns an entirely new array with transformed elements and the same amount of data.
